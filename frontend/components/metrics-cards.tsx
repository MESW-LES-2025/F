...
export function MetricsCards() {
  ...
  const topSpender = Object.entries(spenderAmounts)
    .sort(([, a], [, b]) => b - a)[0]?.[0] || 'N/A'
  ...
  const metrics = [
    { label: "Tasks Completed", value: isLoading ? "..." : String(tasksCompleted) },
    { label: "Pending Tasks", value: isLoading ? "..." : String(pendingTasks) },
    { label: "Top Contributor", value: isLoading ? "..." : topContributor },
    { label: "Total Expenses", value: isLoading ? "..." : `${totalExpenses.toFixed(2)}€` },
