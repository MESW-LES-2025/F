    ...
    <div className="space-y-6">
        ...
        <Card className="p-6 bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
          ...
          <p className="text-3xl font-bold text-purple-900">
            ...
            {summary.expenseCount > 0
              ? (summary.totalSpending / summary.expenseCount).toFixed(2)
              : "0.00"}
          </p>
        </Card>
      </div>
      ...
      <Card className="p-6 bg-white border border-gray-200">
        ...
        <div className="mt-4 text-sm text-gray-500">
          <p>
            • <strong>Total Paid:</strong> Amount the person has paid for
            expenses
          </p>
          <p>
            • <strong>Total Owed:</strong> Amount the person owes for their
            share of expenses
          </p>
          <p>
            • <strong>Balance:</strong> Net amount (positive = owed to them,
            negative = they owe)
          </p>
        </div>
      </Card>
