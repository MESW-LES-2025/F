...
function TaskColumn({
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
      className={`${bgColor} rounded-lg p-4 min-h-[300px] lg:min-h-[500px]`}
    >
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex -space-x-1">
                      ...
                      {task.assignedUsers && task.assignedUsers.length > 3 && (
                        <div className="w-6 h-6 bg-gray-200 text-[10px] flex items-center justify-center rounded">
                      ...
                      onClick={async (e) => {
                        ...
                        try {
                          ...
                          toast({
                            ...
                            description: String(
                              (err as any)?.message || "Could not archive",
                            ),
                          });
                        }
                      }}
