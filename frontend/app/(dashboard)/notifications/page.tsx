    ...
    async (initial = false) => {
      ...
      try {
        ...
        if (activeCategory !== "ALL")
          filters.category = activeCategory as NotificationCategory;
  ...
  const markAll = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Could not mark all notifications",
        variant: "destructive",
      });
    } finally {
      setMarkingAll(false);
                  ...
                  return (
                    ...
                    >
                      <div className="mt-1 shrink-0">
                        {iconForCategory(n.notification.category || null)}
                      </div>
